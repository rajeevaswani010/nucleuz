    ...
    <div class="container-fluid page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
        <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
            ...
            <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                <h2 class="mb-0">{{ __("View Company") }}</h2>
            </div>

            <div><a href="{{ URL('office/create') }}"><button class="btn btn-primary">{{ __("Add New") }}</button></a></div>
        </div>
    </div>
</div>
                ...
                <table class="table mb-0 thead-border-top-0 table-nowrap">
                    <thead>
                        <tr>
                            ...
                            <th><a href="javascript:void(0)" class="sort" data-sort="js-lists-values-employee-name">{{ __("Address") }}</a></th>
                    ...
                    <tbody class="list" id="search">
                        ...
                        <tr>
                            ...
                            <td>{{ $DT->address }}</td>
                            <td class="pl-0">
                                <a href="{{ URL('office') }}/{{ $DT->id }}/edit" class="text-50"><i class="material-icons">edit</i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
