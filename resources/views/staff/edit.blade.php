    ...
    <div class="dash-content">
                ...
                <div class="row align-items-center">
                    <div class="col-auto">
                        <div class="page-header-title">
                            <h4 class="m-b-10">{{ __("Edit Staff") }}</h4>
                        </div>
                        <ul class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="{{ URL('dashboard') }}">{{ __("Dashboard") }}</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">{{ __("Edit Staff") }}</li>
                        </ul>
                    </div>
        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                {!! Form::open(['url' => 'staff/'.$Data->id, 'enctype' => 'multipart/form-data', 'method' => 'PUT']) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input class="form-control font-style" required name="mobile" type="text" value="{{ $Data->mobile }}" />
                        </div>


                        <div class="form-group col-12">
                            <label for="subject" class="col-form-label text-dark">{{ __("Email") }}</label>
                            <input class="form-control font-style" disabled required name="email" type="text" value="{{ $Data->email }}" />
                        </div>
