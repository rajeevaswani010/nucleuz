                ...
                <div class=" pt-32pt pt-sm-64pt pb-32pt">
                    <div class="container-fluid page__container">
                        @if(Session::has('Danger'))
                          ...
                          <div class="text-center"><p>Reset your password</p></div>
                        {!! Form::open(['url' => 'DoSetPassword', 'class' => 'col-md-5 p-0 mx-auto', 'enctype' => 'multipart/form-data', 'method' => 'post']) !!}
                            ...
                            <span class="text-danger">Password must contain Numaric, Letters, Special Characters</span>
