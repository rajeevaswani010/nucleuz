...
<tbody>
    ...
    <div class="action-btn bg-primary ms-2" style="opacity: 0.5;" >
            <a href="{{ URL('booking') }}/{{ $DT->booking_id }}/edit" class="disabled mx-3 btn btn-sm align-items-center" data-url="{{ URL('booking') }}/{{ $DT->booking_id }}/edit" data-ajax-popup="true" data-title="Edit Coupon" data-bs-toggle="tooltip"  title="Edit" data-original-title="Edit">
