...
<div class="container-fluid page__container mt-5 mb-5">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            ...
            <input type="text" class="form-control" name="make" value="{{ old('make') }}" required>
        </div>
        ...
        <div class="col-lg-6 mb-4">
            <label>{{ __("Engine Number") }} <span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="engine_no" value="{{ old('engine_no') }}" required>
        </div>
        ...
        <div class="col-lg-6 mb-4">
            <label>{{ __("Fuel Level Reading") }} <span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="fuel_level_reading" value="{{ old('fuel_level_reading') }}" required>
        </div>

        <div class="col-lg-6 mb-4">
            <label>{{ __("Current Condition") }} <span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="current_condition" value="{{ old('current_condition') }}" required>
        </div>

        <div class="col-lg-4 mb-4">
            <label>{{ __("AC") }} <span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="ac" value="{{ old('ac') }}" required>
        </div>

        <div class="col-lg-4 mb-4">
            <label>{{ __("Audio") }} <span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="Audio" value="{{ old('Audio') }}" required>
        </div>

        <div class="col-lg-4 mb-4">
            <label>{{ __("GPS") }} <span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="gps" value="{{ old('gps') }}" required>
        </div>

        <div class="col-lg-6 mb-4">
            <label>{{ __("Car Image") }} <span class="text-danger">*</span></label>
            <input type="file" class="form-control" name="car_image" required accept="image/png, image/gif, image/jpeg" >
        </div>

        <div class="col-lg-6 mb-4">
            <label>{{ __("Car Conditions Image") }} <span class="text-danger">*</span></label>
            <input type="file" class="form-control" name="car_condition_image" required accept="image/png, image/gif, image/jpeg" >
        </div>

        <div class="col-lg-6 mb-4">
            <label>{{ __("Mulkiya Details") }} <span class="text-danger">*</span></label>
            <textarea type="text" class="form-control" name="mulkiya_details" required>{{ old('mulkiya_details') }}</textarea>
        </div>

        <div class="col-lg-6 mb-4">
            <label>{{ __("Insurance Details") }} <span class="text-danger">*</span></label>
            <textarea type="text" class="form-control" name="insurance_detail" required>{{ old('insurance_detail') }}</textarea>
        </div>
    </div>
