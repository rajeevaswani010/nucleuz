...
<div class="container-fluid page__container mt-5 mb-5">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            ...
            <input type="text" class="form-control" name="engine_no" value="{{ $Data->engine_no }}" required>
        </div>
        ...
        <div class="col-lg-6 mb-4">
            ...
            <input type="text" class="form-control" name="fuel_level_reading" value="{{ $Data->fuel_level_reading }}" required>
        </div>

        <div class="col-lg-6 mb-4">
            <label>{{ __("Current Condition") }} <span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="current_condition" value="{{ $Data->current_condition }}" required>
        </div>

        <div class="col-lg-4 mb-4">
            <label>{{ __("AC") }} <span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="ac" value="{{ $Data->ac }}" required>
        </div>

        <div class="col-lg-4 mb-4">
            <label>{{ __("Audio") }} <span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="Audio" value="{{ $Data->Audio }}" required>
        </div>

        <div class="col-lg-4 mb-4">
            <label>{{ __("GPS") }} <span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="gps" value="{{ $Data->gps }}" required>
        </div>

        <div class="col-lg-6 mb-4">
            <label>{{ __("Car Image") }}</label>
            <input type="file" class="form-control" name="car_image" accept="image/png, image/gif, image/jpeg">
            <img src="{{ URL('public') }}/{{ $Data->car_image }}" style="width: 200px;">
        </div>
        ...
        <div class="col-lg-6 mb-4">
            ...
            <textarea type="text" class="form-control" name="mulkiya_details" required>{{ $Data->mulkiya_details }}</textarea>
        </div>

        <div class="col-lg-6 mb-4">
            <label>{{ __("Insurance Details") }} <span class="text-danger">*</span></label>
            <textarea type="text" class="form-control" name="insurance_detail" required>{{ $Data->insurance_detail }}</textarea>
        </div>
    </div>
